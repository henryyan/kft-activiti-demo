...
public class ServiceTaskParseHandler extends AbstractExternalInvocationBpmnParseHandler<ServiceTask> {
  ...
  protected void executeParse(BpmnParse bpmnParse, ServiceTask serviceTask) {
      ...
      if (StringUtils.isNotEmpty(serviceTask.getType())) {
        ...
        } else if (serviceTask.getType().equalsIgnoreCase("log")) {
            activity.setActivityBehavior(bpmnParse.getActivityBehaviorFactory().createLogActivityBehavior(serviceTask, bpmnParse.getBpmnModel()));
