...
<head>
	...
	<title>权限系统->帐号管理</title>
	
	<%@ include file="/common/include-base-styles.jsp" %>
	<%@ include file="/common/include-jquery-ui-theme.jsp" %>
	<link href="${ctx }/js/common/plugins/jui/extends/small-multiselect/jquery.multiselect.css" type="text/css" rel="stylesheet" />
	...
	<script src="${ctx }/js/common/plugins/jui/extends/small-multiselect/jquery.multiselect.pack.js" type="text/javascript"></script>
	...
	<script src="${ctx }/js/module/account/user-list.js" type="text/javascript"></script>
	<script src="${ctx }/js/module/account/org-tree.js" type="text/javascript"></script>
</head>

<body>
	<table id="list"></table>
	<div id="pager"></div>
	<div id="orgTreeTemplate" title="请选择一个部门或小组" class="template">
		<div id="orgTree"></div>
	</div>
</body>
</html>
