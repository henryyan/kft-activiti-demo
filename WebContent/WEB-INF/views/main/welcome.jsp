...
<head>
    ...
    <link href="${ctx }/js/common/plugins/jui/extends/portlet/jquery.portlet.min.css?v=1.1.3" type="text/css" rel="stylesheet" />
    ...
    <script src="${ctx }/js/common/plugins/jui/extends/portlet/jquery.portlet.pack.js?v=1.1.3" type="text/javascript"></script>
